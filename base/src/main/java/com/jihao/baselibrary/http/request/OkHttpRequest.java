...
public abstract class OkHttpRequest
{
    ...
    protected void appendHeaders()
    {
        ...
        headerBuilder.add("user-agent","Android JiahaoApp" +  ("com.jiahao.wwc".equals(Preferences.getString("packageName")) ? "(Doc)" : "(Quyun)"));
        headerBuilder.add("version", SystemUtil.getVersionName(OkHttpUtils.mContext));
        headerBuilder.add("sysname","Android " + android.os.Build.VERSION.RELEASE);
        headerBuilder.add("devicetoken", "");
