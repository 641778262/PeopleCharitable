 ...
 */
package com.jihao.baselibrary.common.adapter;
...
public abstract class BaseQuickAdapter<T, H extends BaseAdapterHelper> extends BaseAdapter {
    ...
    protected boolean containsPosition;
//    protected boolean displayIndeterminateProgress = false;
    ...
    public BaseQuickAdapter(Context context, int layoutResId, List<T> data) {
        this(context, layoutResId, data, false);
    }

    public BaseQuickAdapter(Context context, int layoutResId, List<T> data, boolean
            containsPosition) {
        this.data = data;
