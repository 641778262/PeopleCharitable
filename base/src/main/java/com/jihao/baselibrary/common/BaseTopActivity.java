...
public abstract class BaseTopActivity extends BaseActivity {
    ...
    public void setContentView(int resId) {
        ...
        mLeftImageView = findView(R.id.top_bt_left);

        if(!OkHttpUtils.isAssistant) {
            mLeftImageView.setImageResource(R.drawable.icon_back);
        }

        mLeftLayout.setOnClickListener(mListener);
        mRightBtn.setOnClickListener(mListener);
        mRightLayout.setOnClickListener(mListener);
    ...
    public static final int MODE_LEFT = 8;//只展示左边返回按钮
    ...
    protected void hideTopBar() {
        ...
        findViewById(R.id.view_top_divider).setVisibility(View.GONE);
    }
